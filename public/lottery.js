...
let collageName = ["كلية الآداب", "كلية الإدارة والإقتصاد", "كلية التربية البدنية وعلوم الرياضة", "كلية التربية للبنات", "كلية التربية للعلوم الانسانية", "كلية التربية للعلوم الصرفة", "كلية الصيدلة", "كلية الطب", "كلية العلوم", "كلية العلوم الاسلامية", "كلية العلوم السياسية", "كلية القانون", "علوم الحاسوب وتكنولوجيا المعلومات"]
...
let m1Name = ["كلية التربية للعلوم الانسانية","كلية التربية الاساسية حديثة","علوم الحاسوب وتكنولوجيا المعلومات","كلية العلوم السياسية","كلية التربية للعلوم الصرفة","كلية العلوم","كلية الصيدلة","كلية الإدارة والإقتصاد","كلية العلوم الاسلامية","كلية الآداب","كلية الطب","كلية التربية للبنات","كلية التربية البدنية وعلوم الرياضة","كلية القانون"]
let m2Name = ["","","","","","","",""]
let m3Name = ["","","",""]
let m4Name = ["",""]
let m5Name = ""
